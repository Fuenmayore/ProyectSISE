                                    ...
                                    <div class="col-xl-12">
                                        <div class="ms-md-auto pe-md-1 d-flex align-items-center">
                                            <div class="input-group input-group-outline">
                                                <a class="nav-link text-dark btn" href="{{ route('reporteEs') }}">
                                                    <button type="button" href="{{ route('reporteEs') }}" class="btn btn-block btn-warning">
                                                        Atrás
                                                    </button>
                                                </a>
                                                <br>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                                <div class="input-group input-group-outline">
                                                    ...
                                                    <input name="buscarporid" type="search" class="form-control mr-sm-8">
