                                    ...
                                    <div class="col-xl-12">
                                        <div class="ms-md-auto pe-md-1 d-flex align-items-center">
                                            <div class="input-group input-group-outline">
                                                <a class="nav-link text-dark btn" href="{{ route('reporteTecn') }}">
                                                    <button type="button" href="{{ route('reporteTecn') }}" class="btn btn-block btn-warning">
                                                        Atrás
                                                    </button>
                                                </a>
                                                <br>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                                <div class="input-group input-group-outline">
                                                    ...
                                                    <input name="buscarporTecn" type="search" class="form-control mr-sm-8">
