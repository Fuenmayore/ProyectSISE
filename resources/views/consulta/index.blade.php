                            ...
                            <div class="card">
                                ...
                                <div class="card-footer p-3">
                                    <p class="mb-0"><span class="text-danger text-sm font-weight-bolder"></span>
                                        Total aprendices Retirados CNCA</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-warning shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Reportes</h6>
                        ...
                        <div>
                            ...
                            <a class="nav-link text-dark btn" href="{{ route('modal') }}">
                                <button type="button" class="btn btn-warning">
                                    Fichas con deserción
                                </button>
                            </a>
