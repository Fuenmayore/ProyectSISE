                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-warning shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Reporte por Evento</h6>
                        ...
                        <div>
                            ...
                            <a class="nav-link text-dark btn" href="{{ route('fichaEvento') }}">
                                <button type="button" class="btn btn-warning">
                                    Fichas con deserción Evento
                                </button>
                            </a>
                                        ...
                                        <div class="card-body px-0 pb-2">
                                            <div class="table-responsive p-0">
                                                <table class="table  align-items-center mb-0">
                                                    ...
                                                    <tbody>
                                                        @foreach ($reporteEv as $Ev)
                                                            <tr>
                                                                <td class="align-middle text-center">
                                                                    {{ $Ev->Coordinacion->nom_coor }} </td>
                                                                <td class="align-middle text-center">
                                                                    {{ $Ev->suma_total_act }} </td>
                                                                <td class="align-middle text-center">
                                                                    {{ $Ev->registro_coordinacion }}</td>
                                                                <td class="align-middle text-center">
                                                                    {{ $Ev->totald }}%
                                                                </td>
                                                                <td class="align-middle text-center">
