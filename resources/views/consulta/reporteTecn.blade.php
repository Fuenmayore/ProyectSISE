                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-warning shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Reporte por tecnologo</h6>
                        ...
                        <div>
                            ...
                            <a class="nav-link text-dark btn" href="{{ route('fichaTecn') }}">
                                <button type="button" class="btn btn-warning">
                                    Fichas con deserción Tecnologo
                                </button>
                            </a>
                                        ...
                                        <div class="card-body px-0 pb-2">
                                            <div class="table-responsive p-0">
                                                <table class="table  align-items-center mb-0">
                                                    ...
                                                    <tbody>
                                                        @foreach ($reporteTecn as $Tecn)
                                                            <tr>
                                                                <td class="align-middle text-center">
                                                                    {{ $Tecn->Coordinacion->nom_coor }} </td>
                                                                <td class="align-middle text-center">
                                                                    {{ $Tecn->suma_total_act }} </td>
                                                                <td class="align-middle text-center">
                                                                    {{ $Tecn->registro_coordinacion }}</td>
                                                                <td class="align-middle text-center">
                                                                    {{ $Tecn->totald }}%
                                                                </td>
                                                                <td class="align-middle text-center">
