                ...
                <ul class="navbar-nav" id="navbar">
                    ...
                    <li class="nav-items">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('coor_adriana') }}">Fichas en General</a>
                    ...
                    <li class="nav-items">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item"href="{{ route('reporte-adriana') }}">Reporte en General</a>
                              <a class="dropdown-item" href="{{ route('reporte-nivelesAdriana') }}">Niveles</a>
