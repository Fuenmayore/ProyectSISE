        ...
        <aside
            ...
            <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
                <ul class="navbar-nav" id="navbar">
                    <li class="nav-items">
                        <a class="nav-link text-dark active @yield('1') " href="{{ route('homeElkin') }}">
                    ...
                    <li class="nav-items">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('coor_elkin') }}">Fichas en General</a>
                    ...
                    <li class="nav-items">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item"href="{{ route('reporte-elkin') }}">Reporte en General</a>
                              <a class="dropdown-item" href="{{ route('reporte-nivelesElkin') }}">Niveles</a>
                            </div>
                          </div>
                    </li>
