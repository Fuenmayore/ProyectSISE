    ...
    <html lang="en">
      ...
      <head>
        ...
        <script type="text/javascript"
            src="https://cdn.datatables.net/v/bs4-4.6.0/jszip-2.5.0/dt-1.11.3/b-2.0.1/b-colvis-2.0.1/b-html5-2.0.1/b-print-2.0.1/r-2.2.9/datatables.min.js">
        </script>
        ...
        <aside
            ...
            <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
                <ul class="navbar-nav" id="navbar">
                    <li class="nav-items">
                        <a class="nav-link text-dark active @yield('1') " href="{{ route('homeRoberto') }}">
                    ...
                    <li class="nav-items">
                        ...
                        <div class="dropdown">
                            <a class="nav-link text-dark btn  btn-lg dropdown-toggle  @yield('2')" type="button" id="dropdown1" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('coor_roberto') }}">Fichas en General</a>
                    ...
                    <li class="nav-items">
                        ...
                        <div class="dropdown">
                            <a class="nav-link text-dark btn  btn-lg dropdown-toggle  @yield('5')" type="button" id="dropdown2" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item"href="{{ route('reporte-roberto') }}">Reporte en General</a>
                              <a class="dropdown-item" href="{{ route('reporte-nivelesRoberto') }}">Niveles</a>
                            </div>
                          </div>
                    </li>
